    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPromptResponse", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPromptResponse_UserPrompt_UserPromptId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserPromptId = table.Column<long>(type: "bigint", nullable: false),
                    ConfigurationTier = table.Column<int>(type: "int", nullable: false),
                    EvaluatorId = table.Column<long>(type: "bigint", nullable: true),
                    SchoolCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPromptTierConfig", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPromptTierConfig_UserPrompt_UserPromptId",
                        column: x => x.UserPromptId,
                        principalSchema: "dbo",
                        principalTable: "UserPrompt",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PerceptionSurveyResponse", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PerceptionSurveyResponse_PerceptionSurvey_PerceptionSurveyId",
                        column: x => x.PerceptionSurveyId,
                        principalSchema: "dbo",
                        principalTable: "PerceptionSurvey",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SchoolCode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    WfState = table.Column<int>(type: "int", nullable: false),
                    PreConferenceDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ObservationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ObservationDuration = table.Column<short>(type: "smallint", nullable: false),
                    PostConferenceDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IncludeStudentGrowthComponents = table.Column<bool>(type: "bit", nullable: false),
                    ShortName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Title = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    CreationDateTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvidenceItem_UserPromptResponse_UserPromptResponseId",
                        column: x => x.UserPromptResponseId,
                        principalSchema: "dbo",
                        principalTable: "UserPromptResponse",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PerceptionSurveyResponse_PerceptionSurveyId",
                schema: "dbo",
                table: "PerceptionSurveyResponse",
                column: "PerceptionSurveyId");

            migrationBuilder.CreateIndex(
                name: "IX_PerceptionSurveyResponse_PerceptionSurveyStatementId",
                schema: "dbo",
                table: "PerceptionSurveyResponse",
                column: "PerceptionSurveyStatementId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPromptResponse_UserPromptId",
                schema: "dbo",
                table: "UserPromptResponse",
                column: "UserPromptId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPromptTierConfig_UserPromptId",
                schema: "dbo",
