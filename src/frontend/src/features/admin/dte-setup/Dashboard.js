    ...
    <>
      ...
      <Stack spacing={3}>
        <Typography variant="body1">
          District users that are in the role District-wide Teacher Evaluator
          can be configured to be able to evaluate teachers in selected schools.
          Once the user has been configured for a school, the district
          administrator can assign the evaluator in the Assignments section.
        </Typography>
