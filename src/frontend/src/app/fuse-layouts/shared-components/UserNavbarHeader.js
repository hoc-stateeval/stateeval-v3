...
function UserNavbarHeader(props) {
  ...
  return (
    ...
    >
      ...
      <Typography className="text-13 opacity-50 whitespace-nowrap font-medium" color="inherit">
        {workAreaContext.districtName}
      </Typography>
      {workAreaContext.SchoolName ? (
        <Typography className="text-13 opacity-50 whitespace-nowrap font-medium" color="inherit">
          {workAreaContext.schoolName}
        </Typography>
      ) : (
